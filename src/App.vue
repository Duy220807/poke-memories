<template>
  ...
  <p class="copyright">
    ...
    <a href="https://www.youtube.com/watch?v=CHM75-NqOmk&list=PLU4OBh9yHE94sZ3TPGt0QG_PIwrZ1QF6i">view here</a>
  </p>
</template>
<script>
...
export default {
  name: 'App',
  components: {
    MainScreen, InteractScreen, ResultScreen
  },
  data() {
    return {
      settings: {
  ...
  methods: {
    onHandleBeforeStart(config) {
      ...
      this.settings.totalOfBlocks = config.totalOfBlocks;
      const firstCards =
        Array.from({ length: this.settings.totalOfBlocks / 2 },
          (_, i) => i + 1)
